...
import { Plus, Trash2, WandSparklesIcon } from "lucide-react";
  ...
  return (
    <>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="space-x-3">
                  <Button
                    type="button"
                    variant="outline"
                    onClick={() => setIsShowQuestionsModal(true)}
                  >
                    <WandSparklesIcon className="size-4" /> Generate (AI)
                  </Button>
                  <Button
                    type="button"
                    variant="outline"
      ...
      <GenerateQuestionsModal
        open={isShowQuestionsModal}
        onOpenChange={setIsShowQuestionsModal}
